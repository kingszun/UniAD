...
Host-side data preparation for UniAD reproduction (KAK-24).

작업 목적: nuScenes + UniAD ckpts / info pkls 를 host external mount 에 받아둔 후 RunPod network volume 에 1회 upload — GPU pod 가 download 시간 동안 idle 하는 비용을 회피.
