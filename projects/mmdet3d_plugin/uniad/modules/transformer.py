...
def forward_with_grad_control(model, func, *args, with_grad=True, **kwargs):
    if with_grad:
...
class PerceptionTransformer(BaseModule):
    ...
    def __init__(self,
                 ...
                 bev_feat_no_grad=True,  # Save memory cost, default no grad
                 **kwargs):
        ...
        self.bev_feat_no_grad = bev_feat_no_grad
        self.init_layers()
